...
class ClientHandler {
    ...
    startClients(folders) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.supportsMultiFolders) {
                ...
                const readyClient = tfClient.client.onReady().then(() => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    ...
                    if (!multiFoldersSupported) {
                        ...
                        yield this.startClients(folders);
                    }
                }));
    ...
    createTerraformClient(location) {
        ...
        let wsFolder;
        let rootModulePaths;
        let terraformExecPath;
        let terraformExecTimeout;
        let terraformLogFilePath;
        ...
        if (location) {
            ...
            terraformExecPath = vscodeUtils_1.config('terraform-ls', wsFolder).get('terraformExecPath');
            terraformExecTimeout = vscodeUtils_1.config('terraform-ls', wsFolder).get('terraformExecTimeout');
            terraformLogFilePath = vscodeUtils_1.config('terraform-ls', wsFolder).get('terraformLogFilePath');
            ...
            terraformExecPath = vscodeUtils_1.config('terraform-ls').get('terraformExecPath');
            terraformExecTimeout = vscodeUtils_1.config('terraform-ls').get('terraformExecTimeout');
            terraformLogFilePath = vscodeUtils_1.config('terraform-ls').get('terraformLogFilePath');
    ...
    clientSupportsCommand(cmdName, document) {
        var _a;
        const commands = (_a = this.getClient(document).client.initializeResult.capabilities.executeCommandProvider) === null || _a === void 0 ? void 0 : _a.commands;
